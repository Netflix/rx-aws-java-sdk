...
object Bintray {
  ...
  lazy val settings: Seq[Def.Setting[_]] = bintraySettings ++ Seq(
    ...
    bintrayPackage := "rx-aws-java-sdk",
    ...
    pomExtra := (
      <url>https://github.com/netflix/rx-aws-java-sdk/wiki</url>
      <scm>
        <url>git@github.com:netflix/rx-aws-java-sdk.git</url>
        <connection>scm:git:git@github.com:netflix/rx-aws-java-sdk.git</connection>
      </scm>
      <developers>
        <developer>
          <id>bpitman</id>
