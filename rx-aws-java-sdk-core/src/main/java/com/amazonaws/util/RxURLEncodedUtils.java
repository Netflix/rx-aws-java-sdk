 ...
 */
@Immutable
class RxURLEncodedUtils {
    private static final char QP_SEP_A = '&';
    private static final String NAME_VALUE_SEPARATOR = "=";
    private static final Escaper URL_FORM_ESCAPER = UrlEscapers.urlFormParameterEscaper();
    ...
    private static String encodeFormFields(final String content, final String charset) {
        ...
        return encodeFormFields(content, charset != null ? Charset.forName(charset) : StringUtils.UTF8);
    }
    ...
    private static String encodeFormFields (final String content, final Charset charset) {
        ...
        return URL_FORM_ESCAPER.escape(content);
